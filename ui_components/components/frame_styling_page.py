...
def frame_styling_page(mainheader2, project_uuid: str):
    ...
    if st.session_state['frame_styling_view_type'] == "Individual View":
        ...
        if st.session_state['page'] == "Motion":
            ...
            st.session_state['show_comparison'] = st_memory.radio("Show comparison to:", options=["Other Variants", "Source Frame", "Previous & Next Frame", "None"], horizontal=True, key="show_comparison_radio")            
