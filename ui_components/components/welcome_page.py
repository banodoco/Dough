...
def welcome_page():
    ...
    if app_setting.welcome_state == 0:
        ...
        st.markdown("##### First, check out this insanity by the inimitable [Flipping Sigmas](https://www.youtube.com/watch?v=ETfiUYij5UE):")
        vid1, vid2 = st.columns([1,1])
        with vid1:
            st.video("https://banodoco.s3.amazonaws.com/plan/flipping_sigmas.mp4")


        st.markdown("##### Next, look at what [Hannah Submarine](https://twitter.com/I_Han_naH_I) made for Grimes' Coachella set:")
        vid1, vid2 = st.columns([1,1])
        with vid1:
            st.video("https://banodoco.s3.amazonaws.com/plan/hannah_submarine.mp4")

        st.markdown("##### Finally, here's a little video [I made](https://twitter.com/peteromallet) for a poem I love:")
        ...
        with footer1:
            st.markdown("##### There's so much more you can do with Dough - we can't wait to see what you make!")
