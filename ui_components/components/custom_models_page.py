    ...
    with st.expander("Train a new model"):
        ...
        if len(uploaded_files) <= 5 and model_name == "":
            ...
            if st.button("Train Model", disabled=False):
                ...
                model_status = train_model(app_settings, images_for_model, instance_prompt, class_prompt,
                                           max_train_steps, model_name, project_name, type_of_model, type_of_task, resolution)
