...
class CreateTimingDao(serializers.Serializer):
    ...
    animation_style = serializers.CharField(max_length=100, required=False)
...
class CreateSettingDao(serializers.Serializer):
    ...
    default_model_id = serializers.CharField(max_length=255)
    ...
    default_custom_model_id_list = serializers.CharField(default="[]", max_length=1024, required=False)
