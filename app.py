...
def main():
    ...
    if "online" not in st.session_state:
        ...
        if "localhost" not in current_url:
            st.session_state["online"] = True            
             ...
             st.write(st.session_state["welcome_state"])
    ...
    if st.session_state["online"] == False:                        
        if int(st.session_state["welcome_state"]) == 0:
        ...
        elif int(st.session_state["welcome_state"]) == 1:    
            intro1,intro2 = st.columns([3,2])
            with intro1:                    
        ...
        elif int(st.session_state["welcome_state"]) == 2:
            intro1,intro2 = st.columns([3,2])
            with intro1:
        ...
        elif int(st.session_state["welcome_state"]) == 3:
            intro1,intro2 = st.columns([3,2])
            with intro1:
        ...
        elif st.session_state["welcome_state"] == 4:
            intro1,intro2 = st.columns([3,2])
            with intro1:
        ...
        elif int(st.session_state["welcome_state"]) == 5:
            intro1,intro2 = st.columns([3,2])
            with intro1:
        ...
        elif int(st.session_state["welcome_state"]) == 6:  
            intro1,intro2 = st.columns([3,2])
            with intro1:  
            ...
            if project_name == "":
                ...
                if st.session_state["page"] == "Key Frame Selection":
                    ...
                    if st.sidebar.button("Update Video"):
